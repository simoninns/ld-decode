...
The resulting lossless 4fsc sampled CVBS output then requires decode processing in order to result in usable video and sound (in modern formats).  For this please see the [Decode Orc project](https://simoninns.github.io/decode-orc/){target="_blank"}
